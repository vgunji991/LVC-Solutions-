        ...
        >
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}>John S.,</strong> CEO,
                E-commerce Business
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}> Emily K., </strong> CTO,
                Healthcare Firm
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}> Rajesh K., </strong> IT
          ...
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}> Sarah M., </strong> COO,
                Education Sector
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}> Michael T., </strong> VP of
          ...
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}>Lisa P., </strong> Director
          ...
          <SwiperSlide>
            <div className="pt-customer-review">
              ...
              <p className="pt-customer-review-caption">
                <strong style={{ color: "black" }}> Emily K., </strong> CEO,
                E-commerce Business
              </p>
            </div>
          </SwiperSlide>
